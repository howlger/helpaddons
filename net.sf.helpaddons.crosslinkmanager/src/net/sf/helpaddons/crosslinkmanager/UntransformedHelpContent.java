 ...
 */
public class UntransformedHelpContent {
     ...
     */
    public static InputStream getInputStream(String plugin,
                                             String href,
                                             Locale locale) {
        ...
        return openFromPlugin(bundle, hrefWithoutQuery, locale.toString());
     ...
     */
    public static boolean checkExists(String pluginId, String href, Locale locale) {
...
// TODO log
    ...
    // public -> private; Generic added

    private static Map<String, Object> zipCache = new Hashtable<String, Object>();
     ...
     */
    private static InputStream openFromZip(Bundle pluginDesc, String zip, String file, String locale) {
     ...
     * @return an InputStream to the file or <code>null</code> if the file wasn't found
     */
    private static InputStream openFromPlugin(Bundle pluginDesc, String file, String locale) {
     ...
     */
    private static URL find(Bundle pluginDesc, IPath flatFilePath, List<String> pathPrefix) {
     ...
     */
    private static List<String> getPathPrefix(String locale) {
